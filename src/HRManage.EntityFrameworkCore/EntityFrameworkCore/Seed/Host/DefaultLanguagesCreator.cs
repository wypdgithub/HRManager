...
namespace HRManage.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly HRManageDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = HRManageConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(HRManageDbContext context)
        {
            _context = context;
        }
