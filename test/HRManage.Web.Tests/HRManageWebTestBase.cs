...
{
    public abstract class HRManageWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static HRManageWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(HRManageWebMvcModule).Assembly.FullName);
        }
        ...
        protected void UsingDbContext(Action<HRManageDbContext> action)
        {
            using (var context = IocManager.Resolve<HRManageDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected T UsingDbContext<T>(Func<HRManageDbContext, T> func)
        {
            T result;
        ...
        protected async Task UsingDbContextAsync(Func<HRManageDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<HRManageDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<HRManageDbContext, Task<T>> func)
        {
            T result;
